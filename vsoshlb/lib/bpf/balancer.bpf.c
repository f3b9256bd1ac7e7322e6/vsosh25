    ...
    if (!dst) {
      if (pckt.flow.proto == IPPROTO_TCP) {
        ...
        if (pckt.flags & F_SYN_SET) {
          ...
          // trashing or because another vsoshlb is restarting and all the
